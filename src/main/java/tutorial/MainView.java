...
public class MainView extends AppLayout {
    ...
    private Component[] createMenuItems() {
        return new Tab[] {
                ...
                createTab("Miejsce", MiejsceView.class),
                createTab("Sala", SalaView.class),
                createTab("Seans", SeansView.class),
                createTab("Zamowienie", ZamowienieView.class)
        };
    }
